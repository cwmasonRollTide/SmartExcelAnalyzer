...
public interface IDatabaseWrapper
{
    ...
    Task<string> StoreVectorsAsync(ConcurrentBag<ConcurrentDictionary<string, object>> rows, string? documentId = null, CancellationToken cancellationToken = default);
